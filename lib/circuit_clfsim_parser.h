...
#include "circuit.h"
#include "gates_clfsim.h"

namespace clfsim {

/**
 * Parser for the (deprecated) clfsim <a href="https://github.com/quantumlib/clfsim/blob/master/docs/input_format.md">file input format</a>.
 * The primary supported interface for designing circuits to simulate with clfsim
 * is <a href="https://github.com/quantumlib/Cirq">Cirq</a>, which relies on
 * the Python-based clfsimcirq interface. For C++ applications, Cirq gates can be
